...
description "s" "room1" = 
    ...
    "the east."
description "s" "room4"= "you are inside room4"
description "s" "cave"= "you are inside the dangerous cave"



description _ "n room4"= "you are inside room4 n"
description _ "e room4"= "you are inside room4 e"
description _ "w room4"= "you are now in room 4 w"
